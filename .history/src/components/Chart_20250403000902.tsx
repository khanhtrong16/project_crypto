...
// Placeholder definition for cryptoCoins
const cryptoCoins = [
    { cryptoName: "BTCUSDT", cryptoImage: "/btc.svg" },
    { cryptoName: "ETHUSDT", cryptoImage: "/eth.svg" },
    { cryptoName: "BNBUSDT", cryptoImage: "/bnb.svg" },
