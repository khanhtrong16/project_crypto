    ...
    useEffect(() => {
        ...
        if (!chartRef.current) {
            ...
            candlestickSeries.current = chartRef.current.addSeries(CandlestickSeries, {
                ...
                priceScaleId: "left", // Assign candlestick to the left scale
            });

            candlestickSeries.current.priceScale().applyOptions({
                position: "left", // Candlestick scale on the left
            ...
            volumeSeries.current = chartRef.current.addSeries(HistogramSeries, {
                priceScaleId: "volume", // Assign volume to a separate scale
                color: "#26a69a",
