    ...
    useEffect(() => {
        ...
        if (!chartRef.current) {
            ...
            volumeSeries.current.priceScale().applyOptions({
                ...
                autoScale: true, // Tự động điều chỉnh scale để tránh mất volume
                borderVisible: true, // Hiển thị border giữa volume và candlestick
            });

            candlestickSeries.current.priceScale().applyOptions({
                scaleMargins: { top: 0.2, bottom: 0.3 },
                autoScale: true, // Chỉ tự động scale cho nến
            });
